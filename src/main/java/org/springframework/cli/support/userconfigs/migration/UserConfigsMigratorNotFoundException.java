...
/**
 * Exception to be thrown when a suitable migrator could not be found in a given
 * migration service.
 *
 * @author Janne Valkealahti
 */
public class UserConfigsMigratorNotFoundException extends UserConfigsMigrationException {
	 ...
	 */
	public UserConfigsMigratorNotFoundException(@Nullable TypeDescriptor sourceType, TypeDescriptor targetType) {
