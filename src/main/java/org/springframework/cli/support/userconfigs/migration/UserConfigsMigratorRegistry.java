 ...
 */
public interface UserConfigsMigratorRegistry {
	 ...
	 */
	void addMigrator(UserConfigsMigrator<?, ?> migrator);
	 ...
	 */
	<S, T> void addMigrator(Class<S> sourceType, Class<T> targetType, UserConfigsMigrator<? super S, ? extends T> migrator);

	/**
	 * Add a generic converter to this registry.
	 */
	void addMigrator(GenericUserConfigsMigrator migrator);
