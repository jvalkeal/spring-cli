 ...
 */
public class SettingsMigrationFailedException extends SettingsMigrationException {
	 ...
	 */
	public SettingsMigrationFailedException(@Nullable TypeDescriptor sourceType, TypeDescriptor targetType,
