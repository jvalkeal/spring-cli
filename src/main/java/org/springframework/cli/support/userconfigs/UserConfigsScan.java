 ...
 * {@link UserConfigs @UserConfigs} classes. One of
...
@Documented
@Import(UserConfigsScanRegistrar.class)
@EnableUserConfigs
public @interface UserConfigsScan {

	/**
	 * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation
	 * declarations e.g.: {@code @UserConfigsScan("org.my.pkg")} instead of
	 * {@code @UserConfigsScan(basePackages="org.my.pkg")}.
