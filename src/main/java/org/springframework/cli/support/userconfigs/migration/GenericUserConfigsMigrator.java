...
public interface GenericUserConfigsMigrator {
	 ...
	 */
	@Nullable
	Set<GenericUserConfigsMigrator.MigratablePair> getConvertibleTypes();
	...
	final class MigratablePair {
		...
		public boolean equals(@Nullable Object other) {
			...
			if (other == null || other.getClass() != GenericUserConfigsMigrator.MigratablePair.class) {
				return false;
			}
			GenericUserConfigsMigrator.MigratablePair otherPair = (GenericUserConfigsMigrator.MigratablePair) other;
