...
/**
 * {@link ImportBeanDefinitionRegistrar} for {@link UserConfigsScan @UserConfigsScan}.
 *
 * @author Janne Valkealahti
 */
class UserConfigsScanRegistrar implements ImportBeanDefinitionRegistrar {

	private final Environment environment;
	private final ResourceLoader resourceLoader;

	UserConfigsScanRegistrar(Environment environment, ResourceLoader resourceLoader) {
	...
	private Set<String> getPackagesToScan(AnnotationMetadata metadata) {
		AnnotationAttributes attributes = AnnotationAttributes
				.fromMap(metadata.getAnnotationAttributes(UserConfigsScan.class.getName()));
	...
	private ClassPathScanningCandidateComponentProvider getScanner(BeanDefinitionRegistry registry) {
		...
		scanner.addIncludeFilter(new AnnotationTypeFilter(UserConfigs.class));
