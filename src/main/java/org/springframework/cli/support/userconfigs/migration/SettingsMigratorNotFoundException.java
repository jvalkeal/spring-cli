 ...
 */
public class SettingsMigratorNotFoundException extends SettingsMigrationException {
	 ...
	 */
	public SettingsMigratorNotFoundException(@Nullable TypeDescriptor sourceType, TypeDescriptor targetType) {
